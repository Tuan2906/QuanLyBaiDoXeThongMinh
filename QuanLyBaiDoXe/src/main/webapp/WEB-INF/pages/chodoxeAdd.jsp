...
<c:url value="/chodoxe/add" var="action" />
...
<form:form method="post" action="${action}" modelAttribute="chodoxe" class="p-5">
    <div class="mb-3 mt-3">
        <label for="vitri" class="form-label">Vị trí</label>
        <form:input path="vitri" type="number" class="form-control" id="vitri" placeholder="Vị trí" name="vitri" />
        <form:errors path="vitri" cssClass="text-danger" />

    </div>
    <div class="mb-3 mt-3  ">
        <label for="khoangcach" class="form-label">Khoảng cách</label>
        <form:input path="khoangCach" type="number" class="form-control" id="khoangCach" placeholder="Khoảng cách" name="khoangCach" />
        <form:errors path="khoangCach" cssClass="text-danger" />
    </div>
    <div class="mb-3 mt-3">
        <label for="baiDoXeid" class="form-label">Chọn bãi đổ xe</label>
        <form:select path="baiDoXeid" id="baiDoXeid" class="form-select">
    ...
    <div class="mb-3 mt-3">
        ...
        <form:select path="kdxId" id="khuDoXeid" class="form-select">
     ...
     <div class="mb-3 mt-3">
        ...
        <form:select path="giaId" id="khuDoXeid" class="form-select">
     ...
     <div class="mb-3 mt-3">
        ...
        <form:select path="ptId" id="khuDoXeid" class="form-select">
    ...
    <div class="mb-3 mt-3">
        ...
        <form:select path="stateId" id="stateId" class="form-select">
